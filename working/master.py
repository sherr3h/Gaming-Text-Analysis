...
output = pd.DataFrame(list(zip(video_id,films,studios,Trailer_date,like_count,dislike_count,views,comment_count, polarity_column,subjectivity_column,polarity_StdDeviation_column,
subjectivity_StdDeviation_column,previous_month_price_variation,average_volume,month_volatility,
period_price_variation)), columns =["Trailer YT_id","MOVIE","TICKER","Trailer Date","Like","Dislike","Views","Comments","Polarity","Subjectivity","Polarity_Std","Subjectivity_Std",
